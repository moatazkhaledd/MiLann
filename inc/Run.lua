...
msg.TheRank = redis:get(boss..":RtbaNew1:"..msg.chat_id_) or 'المطور الأساسي' 
msg.Rank = 1
...
msg.TheRank = redis:get(boss..":RtbaNew8:"..msg.chat_id_) or 'المالك'
msg.Rank = 22
...
msg.TheRank = redis:get(boss..":RtbaNew3:"..msg.chat_id_) or 'المنشئ اساسي'
msg.Rank = 11
