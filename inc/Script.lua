...
sendMsg(msg.chat_id_,msg.id_,'• تـم تـعـطـيـل الـمـجـمـوعـه 𖤹\n• بواسطه ⋙「 '..NameUser..' 」 \n')
end,{msg=msg})
end
...
send_key(msg.sender_user_id_,'  [قناة السورس: ميلان 𖤹](https://t.me/SORMILAN)',nil,inline,msg.id_)
return false
end
